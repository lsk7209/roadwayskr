...
- 한글 라우트, 사이트맵, 레이아웃, 주말 페이지 인코딩/문법 오류를 복구하고 IndexNow 키까지 설정했습니다.
...
- 05-10: `INDEXNOW_KEY` Production 환경변수와 공개 키 파일 추가
...
- [ ] 운영 배포 후 `https://roadways.kr/f20e78fccc6b2c22c925d4d7ce6e82fd.txt` 확인
